        ...
        <div className="min-h-screen bg-gray-50/50">
            ...
            <aside className="fixed left-0 top-0 z-40 h-screen w-64 bg-white border-r border-gray-100">
                <div className="h-16 flex items-center px-4 border-b border-gray-100">
                    <div className="w-9 h-9 rounded-xl bg-emerald-500 animate-pulse" />
            ...
            <main className="pt-16 pl-64 min-h-screen">
                <div className="p-6 space-y-6">
                    ...
                    <div className="h-24 bg-gradient-to-r from-emerald-400 to-emerald-500 rounded-2xl animate-pulse" />
